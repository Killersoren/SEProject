...
public class ProjectListAdapter
{
  ...
  /**
   * Use the Main.MyFileIO class to retrieve all projects with specified name of member.
   *
   * @param searchPhrase the name to retrieve projects with specified member
   * @return a Project.ProjectList object with projects with specified  member name
   */
